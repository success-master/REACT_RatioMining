...
import DriverDetailStyles from './styles/DriverDetailStyles'
        ...
        <DriverDetailStyles>
            <div className="personnel-detail-container">
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={5}>
                        <StyledCard className="chart-card" style={{ height: 400 }}>
                            <div className="details">
                                ...
                                <div className="info">
                                    <p className="info-title">Toplam Sefer Sayısı:</p>
                                    <span className="info-value"> 50</span>
                                </div>
                                <div className="info">
                                    <p className="info-title">Günlük Ortalama Sefer Sayısı:</p>
                                    <span className="info-value"> 50</span>
                                </div>
                                <div className="info">
                                ...
                                <div className="info">
                                    <p className="info-title">Kayıp Süre:</p>
                                    <span className="info-value"> 50</span>
                                </div>
                            </div>
                        </StyledCard>
                    ...
                    <Grid item xs={12}>
                        <ExpansionPanel  defaultChecked disabled={!personnel}>
...
export default withLayout(DriverDetail)
