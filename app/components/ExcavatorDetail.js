                ...
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <StyledCard className="chart-card">
                            <p className="chart-title">Rpm - Yükleme Grafiği</p>
                            ...
                            <div className="chart-footer-row">
                                <div className="footer-item">
                                    <span className="info-title">Oratlama Taşınan Yük:</span>
                                    <span>50 Ton</span>
                                </div>
                            </div>
                        </StyledCard>
                    ...
                    <Grid item xs={12}>
                        <StyledCard className="chart-card" style={{ height: 200 }}>
                            <p className="chart-title">Ekskavatör Faaliyetleri Grafiği</p>
                        ...
                        <StyledCard className="chart-card">
                            <div style={{ display: 'flex', justifyContent: 'center' }}>
                                <div className="details">
                                    <div className="info">
                                        <p className="detail-title">Görev Başına Ortalama Yüklenen Kamyon Sayısı:</p>
                                        <span className="detail-value"> 50</span>
                                    </div>
                                    <div className="info">
                                        <p className="detail-title">Ortalama ve Toplam Yüklenen Kamyon Sayıları (Gün/Hafta/Ay):</p>
                                        <span className="detail-value"> 10/40/80</span>
                                    </div>
                                    <div className="info">
                                        <p className="detail-title">Ortalama Kamyonu Yükleme Süresi:</p>
                                        <span className="detail-value">1.5 Dk</span>
                                    </div>
                                </div>
                            </div>
                        </StyledCard>
...
export default withLayout(ExcavatorDetail)
